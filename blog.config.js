...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://ntust-dummies.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NTUST Senior', // 您的昵称 例如 tangly1024
