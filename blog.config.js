...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '~歡迎來到台科新生懶人包~',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://for-freshman-in-ntust.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'NTUST, 台科大, 國立台灣科技大學, 新生, freshman, book, 懶人包', // 网站关键词 英文逗号隔开
